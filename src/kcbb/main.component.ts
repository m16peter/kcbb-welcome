...
export class MainComponent {
    ...
    constructor() {
        ...
        this.main = {
            "slider": {
                // an animation during site load
                'slides': ['/kcbb-welcome/assets/svg/loader.svg']
            },
            "nav-bar": {
                'active': '',
                'logo': '',
    ...
    // load slide-images after all is done...
    private loadSlides() {
